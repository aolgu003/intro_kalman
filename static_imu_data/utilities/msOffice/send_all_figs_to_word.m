function send_all_figs_to_word(varargin)
% Send all open figures to Word Doc
% 
% Description:
% Use after creating a group of figure windows so that the last plotted
% figure is the current figure.  The figure windows are not resized before
% sending to the Word document.
% 
% Syntax:
%   [] = send_all_figs_to_word(varargin)
% 
% Parameters:
%   varargin:   filename
% 
...
% uncomment the next line to make orientation "Landscape"
